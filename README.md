# <del>코드로 배우는 스프링부트 웹 프로젝트 Part4 Chapter7(완료)</del>
# 코드로 배우는 스프링부트 웹 프로젝트 Part4 Chapter8(진행)
## 프로젝트 명 : mreview  
...
> > #### 8. 파일 업로드 처리  
> > > 8.1 파일 업로드를 위한 설정(387p)  


* ### 설정 
1. #### Gradle projects 에서 'Build and run using', 'Run tests using' 변경하기  
   * Ctrl + Alt + S 눌러서 setting 들어가기<br>![](pictures/IDE_Setting1.jpg)  

2. #### Annotation Processors 체크  
   * <br>![](pictures/IDE_Setting2.jpg)  
...
|날짜|내용|
|:---:|:---|
|2021-09-10|Chapter 7 끝내고 Chapter 8 388p까지 완료|
|2021-09-15|Chapter 8(412p)까지 완료|
...
|-|-|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|2021-09-10|이 이후로는 syc브랜치의 commit을 참고해 주세요.|
